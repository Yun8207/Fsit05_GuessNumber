...
public class MainActivity extends AppCompatActivity {
    ...
    private int[] numberRes = {
            R.id.main_btn_0, R.id.main_btn_1, R.id.main_btn_2, R.id.main_btn_3,
            R.id.main_btn_4, R.id.main_btn_5, R.id.main_btn_6, R.id.main_btn_7,
            R.id.main_btn_8, R.id.main_btn_9,
    };
    ...
    private LinkedList<Integer> createAnswer(){
        ...
        HashSet<Integer> nums = new HashSet<>();//HashSet don't repeat
        while (nums.size()<4){
